    ...
    <div class="wrap">
        <form method="POST" action="{{ route('department.store') }}" onSubmit="return checkSubmit()">
            ...
            <div class="department_cd input_wrap">
                ...
                <input type="text" class="form-control input_box" id="SectionCode" name="SectionCode"  value="{{ $input['category_code'] }}" disabled>
            </div>
            <div class="department_name input_wrap">
                <label for="SectionName" class="form-label label">部門名称</label>
                <input type="text" class="form-control input_box" id="SectionName"  name="SectionName" value="{{ $input['category_name'] }}" disabled>
            </div>
            <div class="department_ab_name input_wrap">
                <label for="SectionAbName" class="form-label label">部門略称</label>
                <input type="text" class="form-control input_box" id="SectionAbName" name="SectionAbName"  value="{{ $input['category_ab_name'] }}" disabled>
            </div>
